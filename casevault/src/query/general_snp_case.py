...
class GeneralSnpCase(QueryBase):
    ...
    def get_query_description():
        ...
        return GeneralSnpCase.metadata
    ...
    def execute_hub_query(self, parameters):
        ...
        # If there are no cases matching the variant we can just return empty
        # results
        if len(case_list) == 0:
            return 0
        ...
        # retrieve a list of cases matching a list of clinical indications and
        # cases
